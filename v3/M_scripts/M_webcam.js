...
window.webcam = {
	...
	swf_url: '../M_images/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '../M_images/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '../M_images/shutter.mp3';
	},
