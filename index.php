...
<form name="form1" method="post" action=""  id="form1" enctype="multipart/form-data">
    ...
    <table width="100%">
        ...
        <tr>
            <td width="5%" height="36"><div class="c3"> Email: </div></td>
            <td width="41%"><span class="c4">

              <input class="validate[required,custom[email]]"  type="text" id="from" name="from" placeholder="Base Adress" size="63" />


                </span></td>
            <td width="4%"><div class="c3"> Name: </div></td>
            <td width="50%"><span class="c4">
        <input id="realname" type="text"  name="realname" placeholder="Names seperated by a comma [,]" class="validate[required]" size="64" />
        </span></td>
        </tr>
        <tr>
            <td width="5%" height="58"><div class="c3"> Reply: </div></td>
            <td width="41%"><span class="c4">

              <input id="replyto"  type="text" name="replyto" placeholder="Base Reply:-to, same as sender email recommended" size="63" />
        ...
        <label style="" for="checkbox">
            ...
            <td width="4%"><div class="c3"> Attach File: </div></td>
            <td width="50%"><span class="c4">
        <input type="file" name="file" size="30" />
        </span></td>
        </tr>
        <tr>
            <td width="5%" height="37"><div class="c3"> Subject: </div></td>
            <td colspan="3"><span class="c4">
        <input id="subject"  type="text" name="subject" placeholder="subjects seperated by ||"  size="145" class="validate[required]" />
        </span></td>
        </tr>
        <tr>
            <td width="5%" height="37"><div class="c3">
        ...
        <tr>
            <td width="5%" height="179"
                valign="top"><div class="c3"> Mail HTML: </div></td>
            <td width="41%"
                valign="top"><span class="c4">
        <textarea id="message_html" class="validate[required]" name="message_html" cols="50" rows="10">Your HTML message goes here.
Instructions :
...
What are you waiting for lady ? Go ahead and try it ! I already inserted text for you !
        ...
        <br />
            ...
            <td width="4%"
                valign="top"><div class="c3"> Mail to: </div></td>
            <td width="50%"
                valign="top"><span class="c4">
        <textarea id="emaillist" class="validate[required]" name="emaillist" cols="50" rows="10" placeholder="Emails go here, one email at a line">getoutx@hotmail.com</textarea>
        </span></td>
        </tr>
        <tr>
            <td width="5%"
                valign="top"><div class="c3"> Mail Text: </div></td>
            <td width="41%"
                valign="top"><span class="c4">
 ...
 <textarea id="message_text" class="validate[required]"  name="message_text" cols="50" rows="10">Your TEXT message goes here.
Instructions :
1) [random_string] will be replaced with a random string
2) [random_int] will be replaced with a random int.
3) &amp;to&amp; will be replaced by this email
